...
class Network(object):
    def __init__(self, batch_size=1):
        self._feat_stride = [13, ]
        self._feat_compress = [1. / 13., ]
    ...
    def _anchor_component(self):
        with tf.variable_scope('ANCHOR_' + self._tag) as scope:
            height = tf.to_int32(tf.ceil(self._im_info[0, 0] / 13.))
            width = tf.to_int32(tf.ceil(self._im_info[0, 1] / 13.))
    ...
    def create_architecture(self, sess, mode, num_classes,
        ...
        self._weight_path = caffe_weight_path
        self._tag = tag
